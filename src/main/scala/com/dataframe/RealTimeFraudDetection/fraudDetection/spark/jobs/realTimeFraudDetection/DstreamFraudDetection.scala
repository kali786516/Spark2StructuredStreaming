package com.dataframe.RealTimeFraudDetection.fraudDetection.spark.jobs.realTimeFraudDetection

import com.dataframe.RealTimeFraudDetection.fraudDetection.cassandra.dao.{CreditcardTransactionRepository, KafkaOffsetRepository}
